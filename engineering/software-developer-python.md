...
version: 1.1.0
description: Use this agent when building or maintaining Python backends, APIs, and services using frameworks such as Django, Flask, or FastAPI. Examples:

<example>
Context: Building a backend service
user: "Build the API for our ticket triage service in Python"
assistant: "I'll use the software-developer-python agent to implement a clean FastAPI backend with sensible boundaries and error handling."
</example>

<example>
Context: Maintaining a Django application
user: "Add reporting endpoints to our existing Django app"
assistant: "I'll use the software-developer-python agent to extend the Django backend without disrupting existing behavior."
</example>
color: blue
