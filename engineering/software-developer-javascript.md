...
version: 1.1.0
description: Use this agent when building or maintaining JavaScript and TypeScript frontends using frameworks such as React or Angular. Examples:

<example>
Context: Building a user interface
user: "Build the frontend for our ticket triage dashboard"
assistant: "I'll use the software-developer-javascript agent to implement a maintainable React frontend in TypeScript."
</example>

<example>
Context: Maintaining an Angular application
user: "Add a filtering panel to our existing Angular app"
assistant: "I'll use the software-developer-javascript agent to extend the Angular frontend without regressions."
</example>
color: blue
